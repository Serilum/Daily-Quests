...
public class DailyQuestTrackEvents {
	public static void onPlayerTick(Level level, Player player) {
		...
		if (CompleteQuests.hasQuestType(QuestWrapper.EXPLORE_BIOME, player)) {
			CompleteQuests.updateQuestProgression(QuestWrapper.EXPLORE_BIOME, level, (ServerPlayer)player, ExploreBiome.staticGetIdentifierFromObject(level, level.getBiome(player.blockPosition()).value()), 1);
		}
		...
		if (CompleteQuests.hasQuestType(QuestWrapper.TRAVEL_BLOCKS, player)) {
			...
			if (Variables.lastPlayerLocation.containsKey(playerUUID)) {
				...
				if (distance > 0) {
					CompleteQuests.updateQuestProgression(QuestWrapper.TRAVEL_BLOCKS, level, (ServerPlayer) player, TravelBlocks.staticGetIdentifierFromObject(level, null), distance);
				}
			}
	...
	public static void onBlockBreak(Level level, Player player, BlockPos blockPos, BlockState blockState, BlockEntity blockEntity) {
		...
		Identifier blockIdentifier = level.registryAccess().lookupOrThrow(Registries.BLOCK).getKey(blockState.getBlock());
	...
	public static void onLivingDeath(Level level, LivingEntity livingEntity, DamageSource damageSource) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.SLAY_MOB, level, serverPlayer, SlayMob.staticGetIdentifierFromObject(level, livingEntity.getType()), 1);
	}
	...
	public static void onSheepShear(Level level, Player player, Sheep sheep) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.SHEAR_SHEEP, level, (ServerPlayer)player, ShearSheep.staticGetIdentifierFromObject(level, sheep.getType()), 1);
	}
	...
	public static void onBreeding(Level level, @Nullable Player causedByPlayerIn, Mob parentA, Mob parentB, AgeableMob offspring) {
		...
		TaskFunctions.enqueueCollectiveServerTask(level.getServer(), () -> {
			...
			CompleteQuests.updateQuestProgression(QuestWrapper.BREED_MOB, level, (ServerPlayer)causedByPlayer, BreedMob.staticGetIdentifierFromObject(level, offspring.getType()), 1);
		}, 0);
	}
	...
	public static void onItemCraft(Level level, Player player, ItemStack itemStack) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.CRAFT_ITEM, level, (ServerPlayer)player, CraftItem.staticGetIdentifierFromObject(level, itemStack.getItem()), count);
	}
	...
	public static void onItemUseFinished(Level level, Player player, ItemStack usedItem) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.USE_ITEM, level, (ServerPlayer)player, UseItem.staticGetIdentifierFromObject(level, usedItem.getItem()), 1);
	}
	...
	public static void onBrewPotion(Level level, Player player, ItemStack itemStack) {
		...
		optionalPotionHolder.ifPresent(potionHolder -> CompleteQuests.updateQuestProgression(QuestWrapper.BREW_POTION, level, (ServerPlayer)player, BrewPotion.staticGetIdentifierFromObject(level, potionHolder.value()), 1));
	}
	...
	public static void onEnchantItem(Level level, Player player, ItemStack itemStack) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.ENCHANT_ITEM, level, (ServerPlayer)player, EnchantItem.staticGetIdentifierFromObject(level, itemStack.getItem()), 1);
	}
	...
	public static void onGainExperienceLevel(Level level, Player player, int count) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.GAIN_LEVEL, level, (ServerPlayer)player, GainLevel.staticGetIdentifierFromObject(level, null), count);
	}
	...
	public static void onSmeltItem(Level level, Player player, ItemStack itemStack) {
		...
		Identifier resultIdentifier = level.registryAccess().lookupOrThrow(Registries.ITEM).getKey(itemStack.getItem());
		if (resultIdentifier == null) {
			return;
		}

		for (Identifier ingredientIdentifier : Variables.smeltableItems.get(resultIdentifier)) {
	...
	public static void onTameAnimal(Level level, Player player, TamableAnimal tamableAnimal) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.TAME_ANIMAL, level, (ServerPlayer)player, TameAnimal.staticGetIdentifierFromObject(level, tamableAnimal.getType()), 1);
	}
	...
	public static void onVillagerTrade(Level level, Player player, Villager villager) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.TRADE_VILLAGER, level, (ServerPlayer)player, TradeVillager.staticGetIdentifierFromObject(level, villager.getVillagerData().profession().value()), 1);
	}
	...
	public static void onCreeperIgnite(Level level, Player player, Creeper creeper) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.IGNITE_CREEPER, level, (ServerPlayer)player, IgniteCreeper.staticGetIdentifierFromObject(level, null), 1);
	}
	...
	/* public static void onArrowBlock(Level level, Player player) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.BLOCK_ARROW, level, (ServerPlayer)player, BlockArrow.staticGetIdentifierFromObject(level, null), 1);
	} */
	...
	public static void onGhastReflect(Level level, Player player, Ghast ghast) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.REFLECT_GHAST, level, (ServerPlayer)player, ReflectGhast.staticGetIdentifierFromObject(level, null), 1);
	}
	...
	public static void onRaidComplete(Level level, Player player, Raid raid) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.COMPLETE_RAID, level, (ServerPlayer)player, CompleteRaid.staticGetIdentifierFromObject(level, null), 1);
	}
	...
	public static void onHoneyCollect(Level level, Player player) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.COLLECT_HONEY, level, (ServerPlayer)player, CollectHoney.staticGetIdentifierFromObject(level, null), 1);
	}
	...
	public static void onFishCatch(Level level, Player player) {
		...
		CompleteQuests.updateQuestProgression(QuestWrapper.CATCH_FISH, level, (ServerPlayer)player, CatchFish.staticGetIdentifierFromObject(level, null), 1);
	}
}